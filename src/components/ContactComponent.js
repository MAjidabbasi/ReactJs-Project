...
import { Breadcrumb, FormFeedback, BreadcrumbItem,FormText, Form, FormGroup, Button, Label, Col, Input } from 'reactstrap';
...
class Contact extends Component {
    ...
    handleSubmit(event) {
        ...
        if(errors.firstname.length !== 0 && errors.lastname.length !== 0 && errors.telnum.length !== 0 && errors.email.length !== 0) 
